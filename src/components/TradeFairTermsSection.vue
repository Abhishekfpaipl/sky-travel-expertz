    ...
    <div class="container mt-4 text-start">
        ...
        <ul class="list-group mb-4 list-group-flush">
            <li class="list-group-item">A Registration fee (75,000 Per Person) is required at the time of booking
                (Non-Refundable).</li>
            <li class="list-group-item">To confirm your booking, please provide complete registration form along with
                all required documents.</li>
            <li class="list-group-item">Full payment must be received by 4 weeks before departure to secure your spot.
            </li>
            <li class="list-group-item">Late payment may result in a change to your deposit or cancellation of the
                booking.</li>
        </ul>
        ...
        <ul class="list-group mb-4 list-group-flush">
            ...
            <li class="list-group-item">Between 45 to 21 days prior to departure: 75% of package price</li>
            <li class="list-group-item">Between 20 to 0 days prior to departure: 100% of package price</li>
        ...
        <ul class="list-group mb-4 list-group-flush">
            ...
            <li class="list-group-item">It is your responsibility to ensure you have a valid passport and any necessary
                visas for your trip.</li>
            <li class="list-group-item">Travel insurance is highly recommended.</li>
            <li class="list-group-item">Red Carpet Tours is not liable for any personal injury, loss, or damage suffered
                during your trip.</li>
        </ul>
    </div>
</template>
